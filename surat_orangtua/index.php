...
$stmt = $pdo->query("
    ...
    GROUP BY siswa.id_siswa, siswa.nama, siswa.nis, kelas.tingkat, kelas.jurusan, kelas.nama_kelas
    HAVING total_poin >= 20 AND total_poin <= 30
...
<div class="container">
    <h2>Daftar Panggilan Orang Tua</h2>

    <table id="suratTable" class="display">
        <thead>
            <tr>
                <th>No</th>
                <th>Nama Siswa</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="cetak_panggilan.php?id_siswa=<?= $row['id_siswa']; ?>" target="_blank" class="btn">
                        Cetak Panggilan
                    </a>
                </td>
            </tr>
