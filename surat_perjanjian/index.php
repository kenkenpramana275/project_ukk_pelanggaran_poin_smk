...
$stmt = $pdo->query("
    SELECT 
        ...
        siswa.pekerjaan_orang_tua,
        siswa.alamat,
        siswa.kontak_orang_tua,
    ...
    GROUP BY 
        ...
        siswa.alamat,
        siswa.kontak_orang_tua
    HAVING total_poin >= 40 AND total_poin <= 75
...
<div class="container">
    ...
    <table id="perjanjianTable" class="display">
        <thead>
            <tr>
                <th>No</th>
                <th>Nama Siswa</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="cetak_perjanjian.php?id_siswa=<?= $row['id_siswa']; ?>" target="_blank" class="btn">
                        Cetak Perjanjian
                    </a>
                </td>
            </tr>
